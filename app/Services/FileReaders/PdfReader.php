...
namespace Modules\Financial\Services\FileReaders;

use Smalot\PdfParser\Parser;
use Smalot\PdfParser\Config;
use Modules\Financial\Interfaces\FileReaderInterface;
use Modules\Financial\Interfaces\BankStatementParserInterface;
...
class PdfReader implements FileReaderInterface
{
	...
	private function parseTransactionLine(string $line): array
	{
		...
		if (
			...
			// Remove date from line to make further parsing easier
